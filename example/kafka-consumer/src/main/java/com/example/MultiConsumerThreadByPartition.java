...
public class MultiConsumerThreadByPartition {
    ...
    private final static List<ConsumerWorkerByPartition> workerThreads = new ArrayList<>();
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < CONSUMER_COUNT; i++) {
            ConsumerWorkerByPartition worker = new ConsumerWorkerByPartition(configs, TOPIC_NAME, i);
    ...
    static class ShutdownThread extends Thread {
        public void run() {
            workerThreads.forEach(ConsumerWorkerByPartition::shutdown);
